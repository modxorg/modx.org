...
$_lang['setting_area_general'] = 'Allmänna inställningar';
...
$_lang['setting_redactor.linkEmail'] = 'E-post länkar';
$_lang['setting_redactor.linkEmail_desc'] = 'När aktiverad kommer <em>Infoga länk</em> rutan att innehålla en flik för att infoga <code>mailto:</code> länkar.';

$_lang['setting_redactor.linkResource'] = 'Resurslänkar';
$_lang['setting_redactor.linkResource_desc'] = 'När aktiverad kommer <em>resurs länk</em> rutan att innehålla en flik för att infoga länkar till andra MODX resurser.';

$_lang['setting_redactor.minHeight'] = 'Minimi höjd';
$_lang['setting_redactor.minHeight_desc'] = 'Användt tillsammans med alternativet <code>Automatisk storleksanpassning</code>, låter minimi höjd konfigurationen dig ange antingen ett minimum (när automatisk storleksanpassning är aktiverat) eller fast (när automatisk storleksanpassning inaktiveras) höjd för textområdet. Höjden är i pixlar och behöver endast ett heltal i inställningen.';

$_lang['setting_redactor.modalOverlay'] = 'Överlägg';
...
$_lang['setting_redactor.placeholder'] = 'Platshållare';
...
$_lang['setting_redactor.shortcuts'] = 'Genvägar';
...
$_lang['setting_redactor.visual'] = 'Visuell';
$_lang['setting_redactor.visual_desc'] = 'När inställningen är aktiverad, startar redigeraren i visuellt läge (med verktygsfältet och all den godheten), men när det är inaktiverat är kodvyn (HTML) standard. Mycket användbart som en användarinställning!';

$_lang['setting_redactor.wym'] = 'WYM (visuell struktur)';
...
$_lang['setting_redactor.direction'] = 'Riktning';
$_lang['setting_redactor.direction_desc'] = 'Anger textriktningen, antingen <code>ltr</code> (vänster till höger) eller <code>rtl</code> (höger-till-vänster).';

$_lang['setting_redactor.lang'] = 'Språk';
...
$_lang['setting_redactor.allowedTags'] = 'Tillåtna taggar';
$_lang['setting_redactor.allowedTags_desc'] = 'Använd antingen inställningen tillåtna taggar eller inställningen nekade taggar - inte båda! När du använder inställningen tillåtna taggar, kan du vitlista accepterade taggar i innehållet - andra kommer att plockas bort.';

$_lang['setting_redactor.boldTag'] = 'Fet tagg';
...
$_lang['setting_redactor.convertDivs'] = 'Konvertera divar';
...
$_lang['setting_redactor.convertLinks'] = 'Konvertera länkar';
...
$_lang['setting_redactor.deniedTags'] = 'Nekade taggar';
...
$_lang['setting_redactor.italicTag'] = 'Kursiv tagg';
...
$_lang['setting_redactor.linebreaks'] = 'Radbyten';
...
$_lang['setting_redactor.marginFloatLeft'] = 'Vänster Float marginal';
...
$_lang['setting_redactor.buttons'] = 'Knappar';
...
$_lang['setting_redactor.colors'] = 'Färger';
...
$_lang['setting_redactor.formattingTags'] = 'Formateringstaggar';
...
$_lang['setting_redactor.searchImages'] = "Sök bilder";
...
$_lang['setting_redactor.additionalPlugins'] = 'Ytterligare plugins';
...
$_lang['setting_redactor.fullpage'] = 'Helsida';
