...
$_lang['setting_redactor.plugin_imageurl'] = 'Image Image Plugin';
$_lang['setting_redactor.plugin_imageurl_desc'] = "When enabled adds options to set insert images directly by URL.";
