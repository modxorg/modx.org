...
$_lang['contentblocks.menu_desc'] = "Zarządzaj polami i układami graficznymi Content Blocks.";
$_lang['contentblocks.mgr.home'] = "Content Blocks";

$_lang['contentblocks.general'] = "Ogólne";
$_lang['contentblocks.properties'] = "Ustawienia";
...
$_lang['contentblocks.link.resource'] = "Resource";
$_lang['contentblocks.link.url'] = "URL";
$_lang['contentblocks.link.email'] = "Email Address";
...
$_lang['contentblocks.error.not_an_export'] = "Plik prawdopodobnie nie jest eksportem z ContentBlocks";
$_lang['contentblocks.error.importing_row'] = "Błąd podczas importu wiersza:";
...
$_lang['contentblocks.error.no_snippets'] = "Brak snippetów gotowych do użycia";
$_lang['contentblocks.error.missing_id'] = "Brak ID";
...
$_lang['contentblocks.error.field_not_found'] = "Nie odnaleziono pliku";
$_lang['contentblocks.error.category_not_found'] = "Category not found";
$_lang['contentblocks.error.layout_not_found'] = "Nie odnaleziono układu graficznego";
$_lang['contentblocks.error.error_saving_object'] = "Błąd podczas zapisu obiektu";
$_lang['contentblocks.error.xml_not_loaded'] = "Nie można załadować pliku XML";
$_lang['contentblocks.error.no_icons'] = "Nie można otworzyć do odczytu folderu z ikonami";
$_lang['contentblocks.error.no_json'] = "Twoja przeglądarka nie wspiera formatu JSON, który jest wymagany do poprawnego działania ContentBlocks. Proszę zaktualizuj swoją przeglądarkę do najnowszej wersji.";

$_lang['contentblocks.availability'] = "Dostępność";
$_lang['contentblocks.availability.layout_description'] = "Domyślnie układy graficzne są zawsze dostępne. Jeżeli dodasz poniżej warunki, będą one widoczne tylko po ich spełnieniu. Użyj przecinka do rozdzielenia wielu wartości.";
$_lang['contentblocks.availability.field_description'] = "Domyślnie pola są zawsze dostępne. Jeżeli dodasz poniżej warunki, będą one widoczne tylko po ich spełnieniu. Użyj przecinka do rozdzielenia wielu wartości.";
...
$_lang['contentblocks.add_condition'] = "Dodaj warunek";
$_lang['contentblocks.edit_condition'] = "Edytuj warunek";
$_lang['contentblocks.delete_condition'] = "Usuń warunek";
$_lang['contentblocks.delete_condition.confirm'] = "Czy na pewno chcesz usunąć ten warunek?";
$_lang['contentblocks.condition_field'] = "Pole";
$_lang['contentblocks.condition_field.resource'] = "ID zasobu";
$_lang['contentblocks.condition_field.parent'] = "ID nadrzedne";
$_lang['contentblocks.condition_field.ultimateparent'] = "ID główne";
$_lang['contentblocks.condition_field.class_key'] = "Class Key";
$_lang['contentblocks.condition_field.context'] = "Context";
$_lang['contentblocks.condition_field.template'] = "Szablon (ID)";
$_lang['contentblocks.condition_field.usergroup'] = "Grupa użytkownika (nazwa)";
$_lang['contentblocks.condition_value'] = "Wartość(ci)";
$_lang['contentblocks.availibility.layouts'] = "Układ(y) graficzne";
...
$_lang['contentblocks.add_field'] = "Dodaj pole";
$_lang['contentblocks.edit_field'] = "Edytuj pole";
$_lang['contentblocks.duplicate_field'] = "Skopiuj pole";
$_lang['contentblocks.delete_field'] = "Usuń pole";
...
$_lang['contentblocks.delete_field.confirm.js'] = "Czy na pewno chcesz usunąć to pole?";
...
$_lang['contentblocks.export_fields'] = "Eksport";
...
$_lang['contentblocks.import_fields.title'] = "Importuj pola";
...
$_lang['contentblocks.add_layout'] = "Dodaj układ graficzny";
$_lang['contentblocks.repeat_layout'] = "Powtórz układ graficzny";
...
$_lang['contentblocks.edit_layout'] = "Edytuj układ graficzny";
$_lang['contentblocks.duplicate_layout'] = "Skopiuj układ graficzny";
$_lang['contentblocks.export_layout'] = "Export Layout";
$_lang['contentblocks.delete_layout'] = "Usuń układ graficzny";
...
$_lang['contentblocks.export_layouts'] = "Eksport";
...
$_lang['contentblocks.import_layouts'] = "Import";
$_lang['contentblocks.import_layouts.title'] = "Importuj układy graficzne";
...
$_lang['contentblocks.layout_settings'] = "Ustawienia układu graficznego";
...
$_lang['contentblocks.add_layoutcolumn'] = "Dodaj kolumnę";
$_lang['contentblocks.edit_layoutcolumn'] = "Edytuj kolumnę";
$_lang['contentblocks.delete_layoutcolumn'] = "Usuń kolumnę";
...
$_lang['contentblocks.add_setting'] = "Dodaj ustawienia";
$_lang['contentblocks.edit_setting'] = "Edytuj ustawienia";
$_lang['contentblocks.duplicate_setting'] = "Duplicate Setting";
$_lang['contentblocks.delete_setting'] = "Usuń ustawienia";
$_lang['contentblocks.delete_setting.confirm'] = "Czy na pewno chcesz usunąć te ustawienia?";
...
$_lang['contentblocks.start_import'] = "Rozpocznij iport";
$_lang['contentblocks.import_file'] = "Plik";
$_lang['contentblocks.import_mode'] = "Tryb importu";
...
$_lang['contentblocks.fields'] = "Pola";
$_lang['contentblocks.layout'] = "Układ graficzny";
$_lang['contentblocks.layout.description'] = "A wrapper for fields";
$_lang['contentblocks.layouts'] = "Układy graficzne";
$_lang['contentblocks.layoutcolumn'] = "Kolumna";
$_lang['contentblocks.layoutcolumns'] = "Kolumny";
$_lang['contentblocks.setting'] = "Ustawienia";
$_lang['contentblocks.settings'] = "Ustawienia";
...
$_lang['contentblocks.name'] = "Nazwa";
$_lang['contentblocks.columns'] = "Kolumny";
...
$_lang['contentblocks.sortorder'] = "Kolejnośc sortowania";
$_lang['contentblocks.icon'] = "Ikona";
$_lang['contentblocks.description'] = "Opis";
$_lang['contentblocks.template'] = "Szablon";
...
$_lang['contentblocks.width'] = "Szerokość";
...
$_lang['contentblocks.save'] = "Zapisz";
$_lang['contentblocks.reference'] = "Reference";
$_lang['contentblocks.default_value'] = "Domyślna wartość";
$_lang['contentblocks.fieldtype'] = "Typ pola";
$_lang['contentblocks.fieldtype.select'] = "Zaznacz";
...
$_lang['contentblocks.fieldtype.textarea'] = "Pole tekstowe";
...
$_lang['contentblocks.directory'] = 'Folder';
