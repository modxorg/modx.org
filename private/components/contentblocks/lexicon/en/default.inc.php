...
$_lang['contentblocks.availability'] = "Availability";
...
$_lang['contentblocks.condition_field'] = "Field";
$_lang['contentblocks.condition_field.resource'] = "Resource ID";
$_lang['contentblocks.condition_field.parent'] = "Parent ID";
...
$_lang['contentblocks.repeat_layout'] = "Repeat Layout";
...
$_lang['contentblocks.edit_layout'] = "Edit Layout";
$_lang['contentblocks.duplicate_layout'] = "Duplicate Layout";
$_lang['contentblocks.export_layout'] = "Export Layout";
$_lang['contentblocks.delete_layout'] = "Delete Layout";
...
$_lang['contentblocks.export_layouts'] = "Export";
...
$_lang['contentblocks.add_layoutcolumn'] = "Add Column";
$_lang['contentblocks.edit_layoutcolumn'] = "Edit Column";
$_lang['contentblocks.delete_layoutcolumn'] = "Delete Column";
...
$_lang['contentblocks.field'] = "Field";
$_lang['contentblocks.fields'] = "Fields";
...
$_lang['contentblocks.table.row_template.description'] = "The template for each of the rows in the table, probably contains a <code>&lt;tr&gt;</code> tag. Available placeholders: <code>[[+row]]</code> (contains each of the cells in this row), <code>[[+idx]]</code>";
...
$_lang['contentblocks.snippet.available_snippets'] = "Names or IDs of allowed Snippets (Optional)";
...
$_lang['contentblocks.use_tinyrte'] = "Use TinyRTE?";
...
$_lang['contentblocks.rebuild_content.loaded_dependencies'] = "Dependencies loaded, starting to rebuild content...";
...
$_lang['setting_contentblocks.crop_jpeg_quality'] = 'Crop Quality (for JPEG)';
$_lang['setting_contentblocks.crop_jpeg_quality_desc'] = 'The JPEG quality to use for generated crop images. This needs to be a numeric value between 1 and 100.';
$_lang['setting_contentblocks.crop_png_compression'] = 'Crop Compression (for PNG)';
$_lang['setting_contentblocks.crop_png_compression_desc'] = 'The PNG compression for generated crop images. This needs to be a numeric value between 1 and 10.';
