...
/**
 */
class cbCategoryUpdateFromGridProcessor extends modProcessor {
    /** @var array $records */
    public $record;
    ...
    public function process() {
        ...
        $object = $this->modx->getObject('cbCategory', $this->record['id']);
        if (!$object) {
            return $this->failure($this->modx->lexicon('contentblocks.error.category_not_found'));
        }
...
return 'cbCategoryUpdateFromGridProcessor';
