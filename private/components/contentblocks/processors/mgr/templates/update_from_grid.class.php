...
/**
 */
class cbTemplateUpdateFromGridProcessor extends modProcessor {
    /** @var array $records */
    public $record;
    ...
    public function process() {
        ...
        $field = $this->modx->getObject('cbTemplate', $this->record['id']);
        if (!$field) {
...
return 'cbTemplateUpdateFromGridProcessor';
