		...
		core: function()
		{
			return {
				...
				setCallback: function(type, e, data)
				{
					...
					this.$element.trigger(eventName, (typeof data == 'undefined') ? e : data); // #modmore #janky
					if (this.$textarea)
					{
		...
		image: function()
		{
			return {
				...
				showEdit: function($image)
				{
                    ...
                    this.$element.trigger('imageEditCallback',$image); // #modmore #janky
				},
				...
				moveResize: function(e)
				{
                    ...
                    this.core.setCallback('moveResize',{el:this.image.resizeHandle,w:width,h:height}); // #modmore #janky #moveResize
				...
				hideResize: function(e)
				{
                    ...
                    imageBox.find('.dimensions').remove(); // #modmore #janky #moveResize
