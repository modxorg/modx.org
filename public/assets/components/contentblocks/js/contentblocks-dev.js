        ...
        addContentModal: function() {
            ...
            ContentBlocks.openModal(_('contentblocks.add_content'), html, {
                initCallback: function(modal) {
                    ...
                    ContentBlocks.liveFilter($('.contentblocks-modal-filter'), $('.contentblocks-add-field-list'));
                },
        ...
        addLayoutModal: function(event) {
            ...
            ContentBlocks.openModal(title, html, {
                initCallback: function(modal) {
                    ...
                    ContentBlocks.liveFilter($('.contentblocks-modal-filter'), $('.contentblocks-add-layout-list, .contentblocks-add-template-list'));
                },
                hasLayoutOptions: true
            });
        },
